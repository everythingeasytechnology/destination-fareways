                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control px-3" id="title" name="title" value="{{ old('title') }}" placeholder="e.g. 10 Best Hidden Beaches in Mallorca" required>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-3">
                                    <label for="slug" class="form-label fw-bold">Auto-Generated URL Slug</label>
                                    <input type="text" class="form-control px-3 font-monospace" id="slug" name="slug" value="{{ old('slug') }}" placeholder="e.g. 10-best-hidden-beaches-mallorca" style="font-size: 0.85rem;">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-3">
                                    <label for="subtitle" class="form-label fw-bold">Sub-heading / Catchphrase</label>
                                    <input type="text" class="form-control px-3" id="subtitle" name="subtitle" value="{{ old('subtitle') }}" placeholder="e.g. Discover pristine sands, turquoise waters, and escape the crowds">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control px-3" id="category" name="category" value="{{ old('category') }}" placeholder="e.g. Travel Guides">
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="mb-3">
                                    <label for="read_time" class="form-label fw-bold">Read Duration</label>
                                    <input type="text" class="form-control px-3" id="read_time" name="read_time" value="{{ old('read_time') }}" placeholder="e.g. 6 min read">
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="mb-3">
                                    <label for="tags" class="form-label fw-bold">Comma-Separated Tags</label>
                                    <input type="text" class="form-control px-3" id="tags" name="tags" value="{{ old('tags') }}" placeholder="e.g. spain, beach, mallorca, summer">
                                </div>
                            </div>
                            ...
                            <div class="col-12 border rounded p-3 bg-light bg-opacity-50 my-3">
                                ...
                                <div class="row g-3">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input type="text" class="form-control px-3 bg-white" id="author_name" name="author_name" value="{{ old('author_name', Auth::user()->name ?? '') }}" placeholder="e.g. Clara Oswald">
                                    </div>
                                    <div class="col-12 col-md-6">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control px-3" id="excerpt" name="excerpt" rows="3" placeholder="Write a short summary (150-200 characters) to show on article listings...">{{ old('excerpt') }}</textarea>
                                </div>
                            </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control px-3" id="seo_keywords" name="seo_keywords" value="{{ old('seo_keywords') }}" placeholder="e.g. mallorca beach guide, best mallorca beaches, spain travel">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-3">
                                    <label for="canonical_url" class="form-label fw-bold">Canonical URL override (optional)</label>
                                    <input type="url" class="form-control px-3" id="canonical_url" name="canonical_url" value="{{ old('canonical_url') }}" placeholder="e.g. https://destinationfareways.com/blogs/original-post-slug">
                                </div>
                            </div>
                                    ...
                                    <textarea class="form-control px-3 font-monospace text-navy" id="schema_markup" name="schema_markup" rows="12" placeholder='<script type="application/ld+json">
{
  ...
  ...
            ...
            <div class="card premium-card border-0 shadow-sm p-4 mb-4">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select px-3" id="is_featured" name="is_featured" required>
                        ...
                        <option value="1">🌟 Promoted Featured Post</option>
                    </select>
                </div>

                <div class="mb-3">
                    <label for="published_at" class="form-label fw-bold">Scheduled / Publish Date</label>
                    <input type="text" class="form-control flatpickr-date px-3" id="published_at" name="published_at" value="{{ old('published_at') }}" placeholder="Defaults to current date">
                </div>
            </div>
    ...
    <div class="border-top pt-3 mt-4 text-end">
        ...
        <button type="submit" class="btn btn-action px-5"><i class="fa-solid fa-floppy-disk me-2"></i>Publish Blog Post</button>
    </div>
</form>
@endsection
