...
@section('content')
<div class="mb-4">
    <h2 class="display-font mb-1 text-navy">Edit Flight Offer</h2>
    <p class="text-muted mb-0">Modify your flight package promotion details, update specs, dates, and manage page attributes.</p>
</div>
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control px-3" id="title" name="title" value="{{ old('title', $offer->title) }}" placeholder="e.g. Flight Deal to London" required>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-3">
                                    <label for="slug" class="form-label fw-bold">URL Slug</label>
                                    <input type="text" class="form-control px-3 font-monospace" id="slug" name="slug" value="{{ old('slug', $offer->slug) }}" placeholder="e.g. flight-deal-london" required style="font-size: 0.85rem;">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-3">
                                    <label for="subtitle" class="form-label fw-bold">Promo Subtitle</label>
                                    <input type="text" class="form-control px-3" id="subtitle" name="subtitle" value="{{ old('subtitle', $offer->subtitle) }}" placeholder="e.g. Autumn Discount Offer">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control px-3" id="from_city" name="from_city" value="{{ old('from_city', $offer->from_city) }}" placeholder="e.g. New York (NYC)" required>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="mb-3">
                                    <label for="to_city" class="form-label fw-bold">Arrival City</label>
                                    <input type="text" class="form-control px-3" id="to_city" name="to_city" value="{{ old('to_city', $offer->to_city) }}" placeholder="e.g. London (LON)" required>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="mb-3">
                                    <label for="airline" class="form-label fw-bold">Airlines Operating</label>
                                    <input type="text" class="form-control px-3" id="airline" name="airline" value="{{ old('airline', $offer->airline) }}" placeholder="e.g. British Airways">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" class="form-control px-3" id="original_price" name="original_price" value="{{ old('original_price', $offer->original_price) }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text">$</span>
                                        <input type="number" step="0.01" class="form-control px-3" id="offer_price" name="offer_price" value="{{ old('offer_price', $offer->offer_price) }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control px-3" id="discount_label" name="discount_label" value="{{ old('discount_label', $offer->discount_label) }}" placeholder="Save $200 Instantly">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control px-3 font-monospace" id="promo_code" name="promo_code" value="{{ old('promo_code', $offer->promo_code) }}" placeholder="e.g. SAVE200">
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="mb-3">
                                    <label for="valid_from" class="form-label fw-bold">Valid From Date</label>
                                    <input type="text" class="form-control flatpickr-date px-3" id="valid_from" name="valid_from" value="{{ old('valid_from', $offer->valid_from ? $offer->valid_from->format('Y-m-d') : '') }}" required>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="mb-3">
                                    <label for="valid_until" class="form-label fw-bold">Valid Until Date</label>
                                    <input type="text" class="form-control flatpickr-date px-3" id="valid_until" name="valid_until" value="{{ old('valid_until', $offer->valid_until ? $offer->valid_until->format('Y-m-d') : '') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control px-3" id="short_desc" name="short_desc" rows="3" placeholder="Teaser card intro...">{{ old('short_desc', $offer->short_desc) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control tinymce-editor" id="description" name="description" rows="10">{{ old('description', $offer->description) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control px-3 seo-input" id="seo_title" name="seo_title" value="{{ old('seo_title', $offer->seo_title) }}" placeholder="Optimize for search engine titles..." data-char-counter="seo-title-count" data-max="60">
                                    <div class="text-end small mt-1"><span id="seo-title-count">{{ strlen($offer->seo_title) }}</span> / 60 characters</div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-3">
                                    <label for="seo_description" class="form-label fw-bold">Meta Description Tag</label>
                                    <textarea class="form-control px-3 seo-input" id="seo_description" name="seo_description" rows="3" placeholder="Write an engaging meta descriptor snippet..." data-char-counter="seo-desc-count" data-max="160">{{ old('seo_description', $offer->seo_description) }}</textarea>
                                    <div class="text-end small mt-1"><span id="seo-desc-count">{{ strlen($offer->seo_description) }}</span> / 160 characters</div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-3">
                                    <label for="seo_keywords" class="form-label fw-bold">Focus SEO Keywords</label>
                                    <input type="text" class="form-control px-3" id="seo_keywords" name="seo_keywords" value="{{ old('seo_keywords', $offer->seo_keywords) }}" placeholder="flight deal, cheap flights">
                                </div>
                            </div>
                            ...
                            <div class="col-12 my-4">
                                ...
                                <div class="p-3 border rounded shadow-sm bg-white" style="font-family: Arial, sans-serif;">
                                    <div class="text-muted" style="font-size: 12px; margin-bottom: 2px;">
                                        https://destinationfareways.com/offers/<span id="prev-seo-slug" class="font-monospace">{{ $offer->slug }}</span>
                                    </div>
                                    <h5 id="prev-seo-title" class="text-primary mb-1 fw-normal" style="font-size: 19px; line-height: 1.3; cursor: pointer;">{{ $offer->seo_title ? $offer->seo_title : $offer->title }}</h5>
                                    <p id="prev-seo-desc" class="text-dark small mb-0" style="font-size: 13px; line-height: 1.4; color: #4d5156 !important;">
                                        {{ $offer->seo_description ? $offer->seo_description : 'Enter description above to simulate this exact search snippet card rendering in live Google search index pages.' }}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="mt-2 p-2 border rounded text-center bg-light d-flex align-items-center justify-content-center" style="height: 120px;">
                                        <img src="{{ $offer->og_image ? asset('storage/' . $offer->og_image) : '' }}" id="og-preview-box" alt="OG Preview" class="img-fluid h-100 {{ $offer->og_image ? '' : 'd-none' }}">
                                        <span class="text-muted small py-3 {{ $offer->og_image ? 'd-none' : '' }}" id="og-preview-placeholder">No image selected</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card premium-card border-0 shadow-sm p-4 mb-4">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select px-3" id="status" name="status" required>
                        <option value="active" {{ $offer->status === 'active' ? 'selected' : '' }}>Active (Visible)</option>
                        <option value="inactive" {{ $offer->status === 'inactive' ? 'selected' : '' }}>Inactive (Hidden)</option>
                    </select>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select px-3" id="is_featured" name="is_featured" required>
                        <option value="0" {{ !$offer->is_featured ? 'selected' : '' }}>Standard Promo Card</option>
                        <option value="1" {{ $offer->is_featured ? 'selected' : '' }} class="fw-bold text-warning bg-navy">🌟 Featured Promoted Offer</option>
                    </select>
                </div>

                <div class="mb-3">
                    <label for="sort_order" class="form-label fw-bold">Card Sort Priority Order</label>
                    <input type="number" class="form-control px-3" id="sort_order" name="sort_order" value="{{ $offer->sort_order }}" min="0" required>
                </div>
            </div>
            ...
            <div class="card premium-card border-0 shadow-sm p-4">
                ...
                <div class="mb-4">
                    ...
                    <div class="mt-2 p-2 border rounded text-center bg-light d-flex align-items-center justify-content-center" style="height: 140px;">
                        <img src="{{ $offer->image ? asset('storage/' . $offer->image) : '' }}" id="cover-preview-box" alt="Cover Preview" class="img-fluid h-100 {{ $offer->image ? '' : 'd-none' }}">
                        <span class="text-muted small py-4 {{ $offer->image ? 'd-none' : '' }}" id="cover-preview-placeholder">No image selected</span>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="mt-2 p-2 border rounded text-center bg-light d-flex align-items-center justify-content-center" style="height: 100px;">
                        <img src="{{ $offer->banner_image ? asset('storage/' . $offer->banner_image) : '' }}" id="banner-preview-box" alt="Banner Preview" class="img-fluid h-100 {{ $offer->banner_image ? '' : 'd-none' }}">
                        <span class="text-muted small py-3 {{ $offer->banner_image ? 'd-none' : '' }}" id="banner-preview-placeholder">No image selected</span>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        // Auto Slug Generation on manual adjustments
        ...
        $('.seo-input').on('input', function() {
            ...
            if (counterId.includes('title')) {
                $('#' + previewId).text(val ? val : ($('#title').val() ? $('#title').val() : 'Flight Deal to London'));
            } else {
