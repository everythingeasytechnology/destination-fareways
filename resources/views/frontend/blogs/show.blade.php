...
<div class="offer-mobile-cta d-lg-none">
    <div class="d-flex gap-2 align-items-center">
        <div class="flex-grow-1">
            <span class="d-block text-muted-white small fw-semibold text-uppercase" style="font-size:.68rem;letter-spacing:.5px;">Cheap Flights</span>
            <span class="text-white fw-bold" style="font-size:.9rem;">Book Now &amp; Save</span>
        </div>
