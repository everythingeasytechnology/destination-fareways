...
<section class="bg-navy text-white py-5 mt-5">
    <div class="container py-4 text-center">
        <h1 class="display-5 fw-bold mb-3" data-aos="fade-up">{{ $page->title ?? 'Refund Policy' }}</h1>
        <p class="lead text-muted-white mb-4" data-aos="fade-up" data-aos-delay="100">
            {{ $page->subtitle ?? 'Refund eligibility, airline rules, and processing timelines.' }}
        </p>
            ...
            <div class="col-lg-9" data-aos="fade-up" data-aos-delay="100">
                <div class="max-width-760 mx-auto">
                    ...
                    <div class="mt-5 border-top pt-4 text-muted small border-light text-center text-md-start">
                        Last modified: {{ date('M d, Y') }}. For booking rules, please review our <a href="{{ route('terms') }}" class="text-navy fw-semibold">Terms & Conditions</a>.
                    </div>
                </div>
            </div>
        </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (headings.length === 0) {
            tocList.innerHTML = '<li class="nav-item text-muted">Refund Details</li>';
            return;
        }
