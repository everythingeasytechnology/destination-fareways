        ...
        <div class="row g-3 align-items-end">
            ...
            <div class="col-lg-5 col-md-12 col-12">
                <div class="row g-2 align-items-center position-relative">
                    ...
                    <!-- Swap Button perfectly absolute-centered (Horizontal for tablet/desktop) -->
                    <div class="swap-btn-absolute d-none d-sm-flex">
                        <button type="button" class="swap-btn" title="Swap locations">
                            <i class="fa-solid fa-arrows-left-right"></i>
                        </button>
                    </div>

                    <!-- Swap Button perfectly absolute-centered (Vertical for mobile) -->
                    <div class="swap-btn-vertical d-flex d-sm-none">
                        <button type="button" class="swap-btn" title="Swap locations">
            ...
            <!-- Passengers & Cabin Class Selector (Integrated inside inputs grid) -->
            ...
            <div class="col-lg-2 col-md-12 col-12">
                <button type="submit" class="btn btn-gold w-100 text-uppercase font-monospace tracking-wide" style="height: 58px; display: flex; align-items: center; justify-content: center; gap: 8px; font-size: 0.95rem; font-weight: 700; border-radius: 8px;">
                    ...
                    <div class="col-12">
                        <div class="row g-2 align-items-end">
                            <div class="col-lg-1 col-md-2 col-12">
                                <span class="badge bg-light text-navy border w-100 py-2.5">Leg {{ $i + 1 }}</span>
                            </div>
